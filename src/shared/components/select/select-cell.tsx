...
const SelectCell = ({item, isSelected, onClick, disabled, isMultiple = false, ...props}: SelectCellProps) => {
    ...
    return (
        <div onMouseDown={(e) => {e.preventDefault()}} onMouseOver={() => handleMouseOver()}
            ...
            <div className={classnames('flex flex-col justify-center w-full', {'py-2': !!item.assistiveText})} data-test-id='select-cell-icon-content' onClick={() => isMultiple && cellClicked()} >
