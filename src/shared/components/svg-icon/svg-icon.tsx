...
const SvgIcon = ({ type, wrapperClassName = '', className = 'icon-medium', fillClass = 'fill-default', fillClass2 = 'fill-default',
    ...
    const getIconCopy = () => {
        return <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet" className={mainClass}>
            <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill={fillClass} stroke="none">
