...
import { toggleCcp, toggleHotspots } from './store/layout.slice'
        ...
        <footer className='h-14 border-t flex-initial w-full bg-primary text-primary'>
            <div className='flex flex-row justify-between w-full h-12'>
                <div className='md:pl-96 flex flex-row items-center'>
                    <div className='pr-5 hidden md:block cursor-pointer'>
                ...
                <div className='items-center flex flex-row pr-7 md:pr-36'>
                    ...
                    <div data-test-id='hotspots-toggle' className='pr-10 hidden md:block cursor-pointer' onClick={() => dispatch(toggleHotspots())}>
                        {t('footer.hotspots')}
                    </div>
                    <div className='pr-1'>
                        {t('footer.status')}
