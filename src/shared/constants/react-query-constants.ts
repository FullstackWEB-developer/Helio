...
export const GetPatientChartAlert = 'patient-chart-alert';
...
export const GetAppointmentTypesForProvider = 'appointment-types-for-provider';
...
export const GetIsEmailBlocked = 'get-is-email-blocked';
export const GetIsSMSBlocked = 'get-is-sms-blocked';
