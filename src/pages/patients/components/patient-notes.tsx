...
const PatientNotes : React.FC<PatientNotesProps> = ({notes}) => {
    ...
    return <div>
        <div className='divide-y divide-gray-200' data-test-id='patient-notes'>
            ...
            {hasMore ? <div data-test-id='patient-notes-show-more' className='flex justify-center cursor-pointer' onClick={() => setShowMore(!showMore)}>{t(showMore ? 'common.show_less' : 'common.show_more')}</div> : ''}
        </div>
}
