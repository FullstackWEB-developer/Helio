...
import { PatientCaseRequest } from '@pages/external-access/models/patient-case-request.model';
...
export const updatePatientContactInformation = async ({
  patientId,
  data,
}: UpdatePatientContactInformationProps) => {
...
export const getPatientByIdWithQuery = async (
  patientId: number,
  queryParams?: GetPatientInfoRequest,
...
export const checkMedicalRecordJobStatus = async (
  messageId: string,
...
export const getAppointmentsForPatientChart = async (
  patientId: number,
): Promise<PatientChartAppointments> => {
...
export const getPatientCases = async ({
  ...
  limit,
  offset,
}: PatientCaseRequest): Promise<PatientCase[]> => {
...
export const checkPatientVerification = async (
  request: CheckPatientVerification,
...
): Promise<CreatePatientResponseModel> => {
...
export const getPatientChartAlert = async (
  patientId: number,
  departmentId: number,
): Promise<ChartAlert> => {
