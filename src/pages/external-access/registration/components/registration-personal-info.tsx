  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col w-full'>
      <div className='flex flex-col md:flex-row md:gap-8'>
        <ControlledInput name='firstName' control={control} label='external_access.first_name' defaultValue='' required={true} containerClassName='md:w-1/2' />
        <ControlledInput name='lastName' control={control} label='external_access.last_name' defaultValue='' required={true} containerClassName='md:w-1/2' />
      </div>
