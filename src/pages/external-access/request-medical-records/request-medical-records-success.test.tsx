...
import RequestMedicalRecordsSuccess from './request-medical-records-success';
...
describe("RequestMedicalRecordsSuccess tests", () => {
    ...
    it("renders RequestMedicalRecordsSuccess correctly", async () => {
        let fragment: any;
        await act(async () => {
