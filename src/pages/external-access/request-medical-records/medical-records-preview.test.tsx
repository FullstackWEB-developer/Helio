...
import MedicalRecordsPreview from './medical-records-preview';
...
describe("MedicalRecordsPreview tests", () => {
    ...
    it("renders MedicalRecordsPreview correctly", async () => {
        let fragment: any;
    ...
    it("renders MedicalRecordsPreview error", async () => {
        let fragment: any;
