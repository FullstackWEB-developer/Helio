...
import RequestMedicalRecords from './request-medical-records';
...
describe("RequestMedicalRecords tests", () => {
    ...
    it("renders RequestMedicalRecords correctly", async () => {
        let fragment: any;
        await act(async () => {
            ...
            fragment = asFragment;
            await waitFor(() => {
                fireEvent.click(getByTestId('time_selection_2'));
            });
        });
