...
import AppointmentRescheduleConfirm from './appointment-reschedule-confirm';
...
describe("AppointmentRescheduleConfirm tests", () => {
    ...
    it("renders AppointmentRescheduleConfirm correctly", async () => {
        let fragment: any;
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "string" })
        let response = {
            appointmentId: "string",
            appointmentStatus: "Future",
            appointmentType: "string",
    ...
    it("renders AppointmentRescheduleConfirm correctly go-back", async () => {
        let fragment: any;
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "string" })
        let response = {
            appointmentId: "string",
