...
describe("AppointmentConfirmation tests", () => {
    ...
    it("renders AppointmentConfirmation correctly spinning", async () => {
    ...
    it("renders AppointmentConfirmation correctly", async () => {
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "123" })
        let fragment: any;
    ...
    it("renders AppointmentConfirmation null correctly", async () => {
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "123" })
        let fragment: any;
        jest.spyOn(Api, 'get').mockImplementation((url) => {
            if (url.includes('/appointmenttypes')) {
    ...
    it("renders AppointmentConfirmation error", async () => {
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "123" })
        let fragment: any;
