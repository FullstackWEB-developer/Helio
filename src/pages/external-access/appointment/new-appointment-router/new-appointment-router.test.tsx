...
import NewAppointmentRouter from './new-appointment-router';
...
describe("NewAppointmentRouter tests", () => {
    ...
    it("renders AppointmentCancel correctly not cancelable", async () => {
