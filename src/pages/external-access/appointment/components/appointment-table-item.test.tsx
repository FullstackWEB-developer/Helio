...
describe("AppointmentTableItem tests", () => {
    ...
    it("renders AppointmentTableItem correctly", async () => {
        ...
        await act(async () => {
            const {asFragment} = render(<TestWrapper mockState={mockState}>
                <AppointmentTableItem isDetailsColumnVisible={true} isRowHoverDisabled={false} isActionColumnVisible={true} onActionClick={() => {}} onClick={() => {}} data={{
                    date: new Date('2022-11-15'),
                    appointmentId: 1,
                    departmentId: 1,
                    localProviderId: 1,
