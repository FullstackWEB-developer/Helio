...
import AppointmentDetailConfirmation from './appointment-detail-confirmation';
...
describe("AppointmentDetailConfirmation tests", () => {
    ...
    it("renders AppointmentDetailConfirmation correctly", async () => {
        let fragment: any;
        await act(async () => {
            const {asFragment, getByTestId} = render(<TestWrapper mockState={mockState}>
                <AppointmentDetailConfirmation appointment={{
                    appointmentId: "string",
                    appointmentStatus: "Future",
                    appointmentType: "string",
                    appointmentTypeId:1,
                    ...
                    startTime: "string",
                    startDateTime: new Date("2022-11-15"),
                } as Appointment} appointmentType={{
                    id: 1,
                    instructions: "string",
                    name: "string",
                    cancelable: true,
                    cancelationTimeFrame: 1,
                    cancelationFee: 1,
                    reschedulable: true,
                    rescheduleTimeFrame: 1,
                    description: "string",
    ...
    it("renders AppointmentDetailConfirmation correctly cancel", async () => {
        let fragment: any;
        await act(async () => {
            const {asFragment, getByTestId} = render(<TestWrapper mockState={mockState}>
                <AppointmentDetailConfirmation appointment={{
