...
describe("AppointmentDetail tests", () => {
    ...
    it("renders AppointmentDetail correctly", async () => {
        ...
        await act(async () => {
            ...
            fragment = asFragment;
            await waitFor(() => {
                fireEvent.click(getByTestId('reschedule'));
            });
        });
        expect(fragment()).toMatchSnapshot();
    });

    it("renders AppointmentDetail correctly cancel", async () => {
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "123" })
        let fragment: any;
        jest.spyOn(Api, 'get').mockImplementation((url) => {
            if (url.includes('/appointmenttypes')) {
    ...
    it("renders AppointmentDetail correctly cancelable not reshcedule", async () => {
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "123" })
        let fragment: any;
        jest.spyOn(Api, 'get').mockImplementation((url) => {
            if (url.includes('/appointmenttypes')) {
    ...
    it("renders AppointmentDetail correctly not cancelable not reshcedule", async () => {
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "123" })
        let fragment: any;
        jest.spyOn(Api, 'get').mockImplementation((url) => {
            if (url.includes('/appointmenttypes')) {
    ...
    it("renders AppointmentDetail correctly not cancelable reshcedule", async () => {
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "123" })
        let fragment: any;
        jest.spyOn(Api, 'get').mockImplementation((url) => {
            if (url.includes('/appointmenttypes')) {
    ...
    it("renders AppointmentDetail correctly no appointment", async () => {
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "123" })
        let fragment: any;
        jest.spyOn(Api, 'get').mockImplementation((url) => {
            if (url.includes('/appointmenttypes')) {
    ...
    it("renders AppointmentDetail correctly error", async () => {
        jest.spyOn(Router, 'useParams').mockReturnValue({ appointmentId: "123" })
        let fragment: any;
