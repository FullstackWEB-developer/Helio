...
import AppointmentFound from './appointment-found';
...
describe("AppointmentFound tests", () => {
    ...
    it("renders AppointmentFound correctly", async () => {
        let fragment: any;
        await act(async () => {
    ...
    it("renders AppointmentFound correctly schedule", async () => {
        let fragment: any;
        await act(async () => {
            const {asFragment, getByTestId} = render(<TestWrapper mockState={mockState}>
                <AppointmentFound/>          
