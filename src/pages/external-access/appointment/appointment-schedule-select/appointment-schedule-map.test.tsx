...
describe("AppointmentScheduleMap tests", () => {
    ...
    it("renders AppointmentScheduleMap correctly", async () => {
        let fragment: any;
        await act(async () => {
            const {asFragment} = render(<TestWrapper mockState={mockState}>
                <AppointmentScheduleMap departmentLatLng={[
                    {
                        latLong: [125, 135],
                        name: "string",
                        address: "string",
