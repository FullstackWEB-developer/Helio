import { AppointmentRemindersPath, SecuritySettingsPath, PracticeBrandingPath, PracticeEmailTemplatePath } from '@app/paths';
...
export const ConfigurationMenuItems = [
  ...
  {
    id: 'configuration-menu-item-20',
    title: 'configuration.business_hours_menu',
    url: 'business_hours',
  },
];
