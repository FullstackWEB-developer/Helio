...
const TicketDepartment = () => {
  ...
  const onAddDepartment = (formData: any) => {
    let ids = departments.map(a => parseInt(a.value));
  ...
  const upsertDepartmentMutation = useMutation(
    ({ label, value, key, isUpdate }: { label: string; value: string; key: string; isUpdate: boolean }) => upsertLookupValue(label, value, key, isUpdate),
    {
      onSuccess: () => {
        onActionCompleted();
        dispatch(
            ...
            <div className='flex flex-col pb-6 ticket-department-modal-title'>
              ...
              <div className='flex justify-end mt-10'>
                ...
                <Button
                  ...
                  type='submit'
                  buttonType='small'
                  disabled={!isDirty || !isValid || upsertDepartmentMutation.isLoading}
