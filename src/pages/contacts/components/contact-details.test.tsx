...
describe("ContactDetails tests", () => {
    ...
    it("renders ContactDetails return correctly", async () => {
        let contact = {
            category: 1,
            companyName: "",
            firstName: "",
        ...
        const {asFragment} = render(<TestWrapper mockState={mockState}>
            <ContactDetails contact={contact} editMode={false} addNewContactHandler={() => {}} onUpdateSuccess={() => {}} onToggleFavoriteSuccess={() => {}} onDeleteSuccess={() => {}}/>
        </TestWrapper>);
