            ...
            <div className="pt-4 px-6 flex flex-col">
                <div className='flex-col items-center pb-2'>
                    ...
                    <div className='flex flex-row pb-3'>
                        <Button data-test-id='apply-button' data-testid='apply-button' className='cursor-pointer mr-4' label='users.filters.apply' buttonType='small' onClick={() => handleSubmit(setFilters)()} ></Button>
                        <Button data-test-id='reset-all-button' data-testid='reset-all-button' className='cursor-pointer' label='users.filters.reset_all' buttonType='secondary' onClick={() => resetForm()}></Button>
                    </div>
                </div>
                <form>
