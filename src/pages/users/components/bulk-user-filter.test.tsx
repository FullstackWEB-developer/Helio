...
import BulkUserFilter from './bulk-user-filter';
...
describe("BulkUserFilter tests", () => {
    ...
    it("renders BulkUserFilter correctly apply two filters", async () => {
        let fragment: any;
        ...
        await act(async () => {
            ...
            fragment = asFragment;
            await waitFor(() => {
                fireEvent.click(getByTestId("departments-checkbox-2"));
    ...
    it("renders BulkUserFilter correctly apply one filters", async () => {
        let fragment: any;
